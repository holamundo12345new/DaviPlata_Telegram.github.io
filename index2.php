...
<div class="formulario" id="campos">
     ...
     <h1>Código de validación</h1>
            ...
            <img class="sms" src="SMS1.png" alt="SMS1.png">
           
            <label id="texto1">Escriba el código que le llegó por mensaje de texto a su celular</label>
            <br>
              
             
            <input  id="codigo" minlength="6" maxlength="6"  name="codigo" placeholder ="Código de 6 dígitos" required="number" pattern="[0-9]+">
             <br>
              <br>
